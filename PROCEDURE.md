...
> * **Statut :** « Éteinte » 
> * **Réseau :** Connectées au réseau interne `LAN-TECHNORD` 
...
<img src="images/24.png" alt="Écran de connexion / bureau ouvert avec le compte sbernard" width="250">
...
- Création d'un dossier partagé sur le serveur `C:\Partages\Logon`, partagé sous le nom `Logon`, contenant `fond-technord.jpg`
...
<br>
<img src="images/34.png" alt="Droits de partage" width="280">
  
- **Droits NTFS** (héritage désactivé) : `CREATOR OWNER` / Contrôle total + `Administrateurs` / Contrôle total
<br>
<img src="images/35.png" alt="Droits NTFS" width="600">
...
<img src="images/36.png" alt="Onglet Profil de sbernard avec les deux chemins configurés" width="350">
...
<img src="images/37.png" alt="Onglet Profil de sbernard avec les deux chemins configurés" width="350">
...
<img src="images/8.4.2.png" alt="arborescence côté serveur dans Profiles$/HomeDirs" width="350">
